 ...
 * field existed.
 */
default_gpu_name: string | null, default_scale: number, default_tile_size: number, default_preset: QualityPreset, output_directory: string | null, sound_muted: boolean, auto_check_updates: boolean, };
